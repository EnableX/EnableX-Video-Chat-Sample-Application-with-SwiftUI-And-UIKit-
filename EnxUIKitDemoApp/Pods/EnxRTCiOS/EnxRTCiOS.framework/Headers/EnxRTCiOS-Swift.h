...
- (void)sendMessage:(NSString * _Nonnull)message isBroadCast:(BOOL)broadcast recipientIDs:(NSArray<NSString *> * _Nullable)clientIds;
...
- (void)didUserStartTyping:(BOOL)isTypping nameOfUser:(NSString * _Null_unspecified)name;
